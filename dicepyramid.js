var jstpl_CardHelpDialog = function (card, cardInfo) { return "\n  <div class=\"card-help\">\n    <!-- <div class=\"card-help-header\">".concat(_(cardInfo.name), "</div> -->\n    <div class=\"card-help-content\">\n        <div class=\"room\">\n            <div class=\"image\" style=\"background-position: ").concat(((card.type - 1) * 100) / 15, "% ").concat(((card.type - 1) * 2 * 100) / 1, "%;\"></div>\n            <div class=\"text\">\n                <div class=\"card-name\">").concat(_(cardInfo.room.name), "</div>\n                <div class=\"card-effect\">").concat(_(cardInfo.room.text), "</div>\n            </div>\n        </div>\n        <div class=\"relic\">\n            <div class=\"image\" style=\"background-position: ").concat(((card.type - 1) * 100) / 15, "% ").concat((((card.type - 1) * 2 + 1) * 100) / 1, "%;\"></div>\n            <div class=\"text\">\n                <div class=\"card-name\">").concat(_(cardInfo.relic.name), "</div>\n                <div class=\"card-effect\">").concat(_(cardInfo.relic.text), "</div>\n            </div>\n        </div>\n    </div>\n  </div>"); };
define([
 ...
 *
 */
var dicepyramid = /** @class */ (function () {
    function dicepyramid() {
        var _this = this;
        ...
        this.cardManager = new CardManager(this, {
            ...
            setupFrontDiv: function (card, div) {
                var cardEl = div.parentElement.parentElement;
                if (card.type)
                    cardEl.classList.add("card-type-".concat(card.type));
                cardEl.classList.toggle("used", card.used);
                if (card.type && card.type_arg) {
                    div.style.backgroundPositionY = "".concat(((card.type_arg - 1) * 100) / 1, "%");
                    div.style.backgroundPositionX = "".concat(((card.type - 1) * 100) / 15, "%");
                    var tooltipHtml = jstpl_CardHelpDialog(card, _this.CARDINFO[card.type]);
                    if (tooltipHtml) {
    ...
    dicepyramid.prototype.onGameUserPreferenceChanged = function (prefId, pref_value) {
        var _a, _b;
        switch (prefId) {
            case 120: // card icon overlays
                console.log(this.prefs);
                for (var _i = 0, _c = Object.entries((_b = (_a = this.prefs) === null || _a === void 0 ? void 0 : _a[prefId]) === null || _b === void 0 ? void 0 : _b.values); _i < _c.length; _i++) {
    ...
    dicepyramid.prototype.setup = function (gamedatas) {
        ...
        document.getElementById("pyramid-card-commands").addEventListener("click", function (e) {
            e.preventDefault();
            e.stopPropagation();
        });
        document.getElementById("relic-card-commands").addEventListener("click", function (e) {
            e.preventDefault();
            e.stopPropagation();
        });
    ...
    //
    dicepyramid.prototype.onEnteringState = function (stateName, e) {
    ...
    //                 You can use this method to perform some user interface changes at this moment.
    //
    dicepyramid.prototype.onLeavingState = function (stateName) {
    ...
    //
    dicepyramid.prototype.onUpdateActionButtons = function (stateName, args) {
        var _this = this;
        var _a;
        console.log("onUpdateActionButtons: " + stateName, args, this.isReadOnly());
        var deselectDice = function () {
            var _a;
            _this.clearSelectedDice(true);
            (_a = document.getElementById("btnRerollSelectedDice")) === null || _a === void 0 ? void 0 : _a.classList.add("disabled");
        };
        var deselectPyramidCards = function () {
            _this.pyramidStock.unselectAll(true);
            document.getElementById("table").appendChild(document.getElementById("pyramid-card-commands"));
        };
        var deselectRelicCards = function () {
            _this.relicStock.unselectAll(true);
        ...
        if (this.isCurrentPlayerActive()) {
            switch (stateName) {
                case "playerBeforeInitialRoll": {
                    ...
                    this.relicStock.setSelectionMode("none");
                    this.statusBar.addActionButton(_("Roll Dice"), function () {
                        var dice = _this.getDice();
                        dice.forEach(function (d) { var _a; return (_a = _this.getDiceElement(d.id)) === null || _a === void 0 ? void 0 : _a.classList.add("rerolling"); });
                        setTimeout(function () {
                            _this.bgaPerformAction("actPlayInitialRoll", {});
                        }, 500);
                    }, {
                ...
                case "playerTurn": {
                    this.statusBar.addActionButton(_("End Game (defeat)"), function () {
                        _this.bgaPerformAction("actGiveUp", {});
                    }, {
                        id: "btnGiveUp",
                        color: "alert",
                        classes: "disabled",
                    });
                    this.enableDefeatButton(!args.rerolls && this.relicStock.getCards().length == 0 && !((_a = args.takeableCards) === null || _a === void 0 ? void 0 : _a.length));
                    // Dice
                    if (args.rerolls) {
                        document.getElementById("dice-box").dataset["action"] = "reroll";
                        this.setDiceSelectable({}, function (selectedDice) {
                    ...
                    this.statusBar.addActionButton(dojo.string.substitute(_("Re-roll (${rerolls_remaining} roll(s) left)"), {
                        rerolls_remaining: args.rerolls,
                    }), function () {
                        if (diceBoxCmd_1.classList.contains("submitting"))
                            return;
                        diceBoxCmd_1.classList.add("submitting");
                        var selectedDice = _this.getSelectedDice();
                        ...
                        color: "primary",
                        classes: "disabled",
                        destination: diceBoxCmd_1,
                    });
                    // Pyramid
                    this.pyramidStock.setSelectionMode("single", args.takeableCards);
                    this.pyramidStock.onSelectionChange = function (selection) {
                    ...
                    this.relicStock.onSelectionChange = function (selection) {
                        if (selection.length > 0) {
                            _this.cardManager.getCardElement(selection[0]).appendChild(document.getElementById("relic-card-commands"));
                            deselectDice();
                            deselectPyramidCards();
                        }
                        else {
                    ...
                    // Pyramid Button
                    this.statusBar.addActionButton(_("Complete Room"), function () {
                        var selectedCard = _this.pyramidStock.getSelection()[0];
                        _this.bgaPerformAction("actTakeRoom", {
                    ...
                    // Relic Buttons
                    this.statusBar.addActionButton(_("Used"), function () { }, {
                        id: "btnUsed",
                        color: "gray",
                        classes: "disabled",
                ...
                case "playerPlayingRelic": {
                    // cancel button
                    this.statusBar.addActionButton(_("Cancel"), function () { return _this.bgaPerformAction("actCancelPlayingRelic", {}); }, { id: "btnCancel", color: "secondary" });
                    if (args.diceCount != null && Math.max.apply(Math, args.diceCount) > 1) {
                        document.getElementById("dice-box-header").innerText = dojo.string.substitute(_("Select ${diceCount} dice"), {
                            diceCount: args.diceCount.join("/"),
                        });
                    }
                    var dice = this.getDice();
                    var selectableDiceIds = args.diceValues
                        ? dice.filter(function (d) { return args.diceValues.includes(d.value); }).map(function (d) { return d.id; })
                        : [0, 1, 2, 3, 4];
                    // Dice
                    var onSelectionChangedForRelic_1 = function (selectedDice) {
                        var enableCmd = false;
                        ...
                        var canTurnUp = !selectedDice.find(function (d) { return d.value == 6; });
                        var canTurnDown = !selectedDice.find(function (d) { return d.value == 1; });
                        document.querySelectorAll(".btn-play-relic-on-dice").forEach(function (el) {
                    ...
                    this.setDiceSelectable({
                        ...
                        count: args.diceCount == null ? null : Math.max.apply(Math, args.diceCount),
                    }, onSelectionChangedForRelic_1);
                    setTimeout(function () { return onSelectionChangedForRelic_1(_this.getSelectedDice()); }, 100);
                    document.getElementById("dice-box").dataset["action"] = args.actionName;
                    if (args.actionName == "turnup" || args.actionName == "turnupdown") {
                        this.statusBar.addActionButton(_("Add 1"), function () {
                            var selectedDice = _this.getSelectedDice();
                            selectedDice.forEach(function (d) { var _a; return (_a = _this.getDiceElement(d.id)) === null || _a === void 0 ? void 0 : _a.classList.add("rerolling"); });
                            setTimeout(function () {
                                return _this.bgaPerformAction("actPlayRelicOnDice", {
                                    diceIds: selectedDice.map(function (d) { return d.id; }).join(","),
                                    actionName: "turnup",
                                });
                            }, 500);
                        }, {
                    ...
                    if (args.actionName == "turndown" || args.actionName == "turnupdown") {
                        this.statusBar.addActionButton(_("Subtract 1"), function () {
                            var selectedDice = _this.getSelectedDice();
                            selectedDice.forEach(function (d) { var _a; return (_a = _this.getDiceElement(d.id)) === null || _a === void 0 ? void 0 : _a.classList.add("rerolling"); });
                            setTimeout(function () {
                                return _this.bgaPerformAction("actPlayRelicOnDice", {
                    ...
                    if (!args.actionName.startsWith("turn")) {
                        ...
                        // Relic action button
                        this.statusBar.addActionButton(actionName, function () {
                            var selectedDice = _this.getSelectedDice();
                            selectedDice.forEach(function (d) { var _a; return (_a = _this.getDiceElement(d.id)) === null || _a === void 0 ? void 0 : _a.classList.add("rerolling"); });
                            setTimeout(function () {
                                return _this.bgaPerformAction("actPlayRelicOnDice", {
    ...
    /*
      ...
      */
    dicepyramid.prototype.isReadOnly = function () {
        return this.isSpectator || typeof g_replayFrom != "undefined" || g_archive_mode;
    };
    dicepyramid.prototype.enableDefeatButton = function (enabled) {
        var _a;
        if (enabled === void 0) { enabled = true; }
        (_a = document.getElementById("btnGiveUp")) === null || _a === void 0 ? void 0 : _a.classList.toggle("disabled", !enabled);
    };
    dicepyramid.prototype.setDiceValues = function (dice) {
        var _a, _b;
        var _loop_3 = function (i) {
            var slot = document.querySelector("#dice-box [data-slot-id=\"".concat(i, "\"]"));
            var val = Number(slot.getAttribute("data-die-value"));
            if (val != dice[i].value) {
                if (slot.classList.contains("rerolling")) {
                    slot.classList.remove("rerolling");
                    slot.setAttribute("data-die-value", ((_b = (_a = dice[i]) === null || _a === void 0 ? void 0 : _a.value) === null || _b === void 0 ? void 0 : _b.toString()) || "0");
                }
                else {
                    slot.classList.add("roll-result");
                    setTimeout(function () { var _a, _b; return slot.setAttribute("data-die-value", ((_b = (_a = dice[i]) === null || _a === void 0 ? void 0 : _a.value) === null || _b === void 0 ? void 0 : _b.toString()) || "0"); }, 500);
                    setTimeout(function () { return slot.classList.remove("roll-result"); }, 1000);
                }
            }
            if (slot.classList.contains("rerolling")) {
                slot.classList.remove("rerolling");
    ...
    dicepyramid.prototype.getSelectedDice = function () {
        return Array.from(document.querySelectorAll("#dice-box .slot.selected")).map(function (el) { return ({
            id: Number(el.getAttribute("data-slot-id")),
            value: Number(el.getAttribute("data-die-value")),
        }); });
    };
    dicepyramid.prototype.getDice = function () {
        return Array.from(document.querySelectorAll("#dice-box .slot")).map(function (el) { return ({
            id: Number(el.dataset.slotId),
            value: Number(el.dataset.dieValue),
        }); });
    };
    dicepyramid.prototype.getDiceElement = function (dieId) {
        return document.querySelector("#dice-box .slot[data-slot-id=\"".concat(dieId, "\"]"));
    };
    dicepyramid.prototype.clearSelectedDice = function (silent) {
        if (silent === void 0) { silent = false; }
        Array.from(document.querySelectorAll("#dice-box .slot.selected")).forEach(function (el) {
            return silent ? el.classList.remove("selected") : el.click();
        });
    };
    dicepyramid.prototype.disableDiceSelection = function () {
        if (this.isSpectator)
            return;
        document.querySelectorAll("#dice-box .dice-slot").forEach(function (el) {
            el.classList.remove("selectable");
            el.classList.remove("selected");
            el.classList.add("disabled");
        });
    };
    dicepyramid.prototype.setDiceSelectable = function (options, onSelectionChanged) {
        var _this = this;
        if (options.ids == null)
            options.ids = [0, 1, 2, 3, 4];
        var setSelectable = function (el, selectable) {
            if (selectable === void 0) { selectable = true; }
            el.classList.toggle("selectable", selectable);
            el.classList.toggle("disabled", !selectable);
        };
        var setDefaultSelectable = function (deselectAll) {
        ...
        document.querySelector("#dice-box").onclick = function (e) {
            var slot = e.target.closest(".slot");
            if (slot === null || slot === void 0 ? void 0 : slot.classList.contains("selectable")) {
                if (options.count == 1) {
                    if (!slot.classList.contains("selected")) {
                        document.querySelectorAll("#dice-box .slot.selected").forEach(function (el) { return el.classList.remove("selected"); });
                    }
                }
                slot.classList.toggle("selected");
                var selectedDice = _this.getSelectedDice();
                if (options.count > 1 && selectedDice.length >= options.count) {
                    document.querySelectorAll("#dice-box .slot:not(.selected)").forEach(function (el) { return setSelectable(el, false); });
                }
                else {
                    setDefaultSelectable();
                }
                onSelectionChanged === null || onSelectionChanged === void 0 ? void 0 : onSelectionChanged(_this.getSelectedDice());
            }
        };
    };
    ///////////////////////////////////////////////////
    ...
    /*
      ...
      */
    dicepyramid.prototype.setupNotifications = function () {
    ...
    dicepyramid.prototype.notif_pyramidSetup = function (e) {
    ...
    dicepyramid.prototype.notif_reRoll = function (e) {
        ...
        var btn = document.getElementById("btnRerollSelectedDice");
        if (btn) {
        ...
        this.enableDefeatButton(!e.args.rerolls && this.relicStock.getCards().length == 0 && !((_a = e.args.takeableCards) === null || _a === void 0 ? void 0 : _a.length));
    };
    dicepyramid.prototype.notif_takeRoom = function (e) {
        console.log("notif_takeRoom", e);
        this.relicStock.addCard(e.args.card);
        for (var _i = 0, _a = e.args.flippedCards; _i < _a.length; _i++) {
            var card = _a[_i];
            this.pyramidStock.setCardVisible(card, true);
        }
    };
    dicepyramid.prototype.notif_playRelic = function (e) {
    ...
    dicepyramid.prototype.notif_playPowerRelic = function (e) {
        console.log("notif_playPowerRelic", e);
        e.args.powerRelic = true;
        this.notif_playRelic(e);
    };
    dicepyramid.prototype.notif_discardRelic = function (e) {
    ...
    dicepyramid.prototype.notif_playingRelic = function (e) {
        console.log("notif_playingRelic", e);
        this.playingRelicStock.addCard(e.args.relicCard);
    };
    dicepyramid.prototype.notif_cancelPlayingRelic = function (e) {
